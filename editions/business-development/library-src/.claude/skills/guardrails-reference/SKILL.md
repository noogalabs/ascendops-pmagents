...
> **Seat pointer:** this file is the framework red-flag table. The seat's own table — the six never-graduates classes and the twenty BD-specific red flags — is in `GUARDRAILS.md` at the template root. Read both. Where they differ, the root file is narrower and wins.

...
1. Update heartbeat/status with the current accounting task.
2. Check inbox/messages and process anything pending.
3. Check pending and in-progress tasks.
4. Verify any money-touching work is blocked on approval.
5. Write a short memory checkpoint.
6. Resume the highest-priority accounting task.
